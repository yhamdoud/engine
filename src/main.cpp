...
int main()
{
    ...
    glVertexArrayVertexBuffer(vao, binding_point, vbo, size_indices,
                              sizeof(vec3));
    ...
    // glEnableVertexArrayAttrib(vao, attrib_tex_coords);
    ...
    // glVertexArrayAttribFormat(vao, attrib_tex_coords, 2, GL_FLOAT, false,
    //                           size_positions + size_normals);

    glVertexArrayAttribBinding(vao, attrib_positions, binding_point);
    glVertexArrayAttribBinding(vao, attrib_normals, binding_point);
    // glVertexArrayAttribBinding(vao, attrib_tex_coords, binding_point);
    ...
    const mat4 model = glm::scale(mat4{1}, vec3{0.01f});
